  ...
  <tbody>
     <?php foreach($auta as $a): ?>
      <tr>
            ...
            <td> 
                <a href="<?php echo base_url()?>/HlavniStrana/EditujAuto/<?php echo $a->idautomobily?>">Upravit</a>
            </td>
            <td> 
                <a href="<?php echo base_url()?>/HlavniStrana/SmazAuto/<?php echo $a->idautomobily?>">Smazat</a>
            </td>
    </tr>
  <?php endforeach; ?>
  </tbody>
